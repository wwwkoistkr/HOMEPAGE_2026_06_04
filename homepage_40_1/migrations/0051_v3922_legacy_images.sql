-- v39.22: 레거시 koist.kr 이미지 13개 → 10개 서비스 페이지 삽입
-- 멱등 마커: <!-- KOIST-LEGACY-IMAGES-v39.22 -->
-- 마지막 "문의 및 상담" 섹션 앞에 이미지 섹션 추가

-- Page 11 (undefined/undefined): undefined
UPDATE dep_pages SET content = '<p class="hero-intro" data-aos="fade-up" style="text-align: center;">정보보호제품이 운영환경에서 정상 및 유해트래픽에 적절히 대응하는지 정도를 기준 및 절차에 따라 성능평가를 실시하여 결과를 제공하는 제도</p>
...
-- Page 14 (undefined/undefined): undefined
...
-- Page 15 (undefined/undefined): undefined
UPDATE dep_pages SET content = '<p class="hero-intro" data-aos="fade-up"></p><div style="text-align: center;"><span style="font-size: 0.875rem;">국가·공공기관 지원 R&amp;D과제 결과물에 대한 제 3자 검증시험 서비스 제공</span></div><div style="text-align: center;"><span style="font-size: 0.875rem;">정량적 지표(성능지표) 수립을 위한 서비스 제공</span></div><div style="text-align: center;"><span style="font-size: 0.875rem;"><br></span></div><p></p>
<section class="service-section" data-koist-block="section">
  <h3 class="service-section-title">목적</h3>
  <div class="service-section-body">
    <ul class="service-bullets">
...
</section>', updated_at = CURRENT_TIMESTAMP WHERE id = 15;

-- Page 16 (undefined/undefined): undefined
UPDATE dep_pages SET content = '<p class="hero-intro" data-aos="fade-up"><div style="text-align: center;"><span style="font-size: 0.875rem;">인공지능(AI) 기술이 포함된 제품 및 알고리즘에 대한 시험 서비스 제공</span></div><div style="text-align: center;"><span style="font-size: 0.875rem;">AI바우처 지원사업에 대한 시험 서비스 제공</span></div><div style="text-align: center;"><span style="font-size: 0.875rem;"><br></span></div></p>
<section class="service-section" data-koist-block="section">
  <h3 class="service-section-title">목적</h3>
  <div class="service-section-body">
    <ul class="service-bullets">
...
</section>', updated_at = CURRENT_TIMESTAMP WHERE id = 16;

-- Page 17 (undefined/undefined): undefined
UPDATE dep_pages SET content = '<p class="hero-intro" data-aos="fade-up"><div style="text-align: center;"><span style="font-size: 0.875rem;">ICT 제품 및 서비스에 대한 네트워크 성능측정</span></div><div style="text-align: center;"><span style="font-size: 0.875rem;">가용성·보안성 측면의 모의훈련 서비스</span></div><div style="text-align: center;"><span style="font-size: 0.875rem;"><br></span></div></p>
<section class="service-section" data-koist-block="section">
  <h3 class="service-section-title">목적</h3>
  <div class="service-section-body">
    <ul class="service-bullets">
...
</section>', updated_at = CURRENT_TIMESTAMP WHERE id = 17;

-- Page 19 (undefined/undefined): undefined
UPDATE dep_pages SET content = '<p class="hero-intro" data-aos="fade-up"><div style="text-align: center;"><span style="font-size: 0.875rem;">실제 공격상황을 대비한 DDoS 대응 모의훈련 서비스</span></div><div style="text-align: center;"><span style="font-size: 0.875rem;">고객사 네트워크 및 보안시스템에 대한 다양한 DDoS 공격을 시도하여 보안 수준 진단</span></div><div style="text-align: center;"><span style="font-size: 0.875rem;"><br></span></div></p>
<section class="service-section" data-koist-block="section">
...
</section>', updated_at = CURRENT_TIMESTAMP WHERE id = 19;

-- Page 23 (undefined/undefined): undefined
UPDATE dep_pages SET content = '<p class="hero-intro" data-aos="fade-up" style="text-align: center;">CC평가를 원하는 고객의 원활한 평가 진행을 위하여 CC 평가 관련 교육 및 평가제출물 작성에 대한 가이드를 제공</p><p class="hero-intro" data-aos="fade-up" style="text-align: center;"><br></p>
<section class="service-section" data-koist-block="section">
...
</section>', updated_at = CURRENT_TIMESTAMP WHERE id = 23;

-- Page 24 (undefined/undefined): undefined
UPDATE dep_pages SET content = '<p class="hero-intro" data-aos="fade-up" style="text-align: center;">검증필 암호모듈의 안전성과 구현 적합성 검증을 원하는 고객의 원활한 진행을 위하여, 검증필 암호모듈 검증 관련 교육 및 제출물 작성에 대한 가이드를 제공</p><p class="hero-intro" data-aos="fade-up" style="text-align: center;"><br></p>
<section class="service-section" data-koist-block="section">
  <h3 class="service-section-title">주요 서비스</h3>
  <div class="service-section-body">
    <ul class="service-bullets">
...
</section>', updated_at = CURRENT_TIMESTAMP WHERE id = 24;

-- Page 25 (undefined/undefined): undefined
UPDATE dep_pages SET content = '<p class="hero-intro" data-aos="fade-up" style="text-align: center;">한국정보보안기술원은 “정보보호 관리체계(ISMS)” 인증을 위한 컨설팅 및 서비스를 제공하고 있습니다.</p><p class="hero-intro" data-aos="fade-up" style="text-align: center;"><br></p>
<section class="service-section" data-koist-block="section">
...
</section>', updated_at = CURRENT_TIMESTAMP WHERE id = 25;

-- Page 27 (undefined/undefined): undefined
UPDATE dep_pages SET content = '<p class="hero-intro" data-aos="fade-up" style="text-align: center;">안전한 정보통신 이용환경 조성을 위해, 정보통신망 이용자의 정보보호 준비 수준을 평가하여 등급을 부여하는 제도로, 과학기술정보통신부가 평가기관을 지정(2016년 4월)</p><p class="hero-intro" data-aos="fade-up" style="text-align: center;"><br></p>
<section class="service-section" data-koist-block="section">
...
</section>', updated_at = CURRENT_TIMESTAMP WHERE id = 27;
